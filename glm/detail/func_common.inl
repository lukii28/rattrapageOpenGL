...
#	endif
	...
	GLM_FUNC_QUALIFIER vec<L, bool, Q> isnan(vec<L, T, Q> const& v)
	{
		...
		vec<L, bool, Q> Result;
		for (length_t longueur_OA = 0; longueur_OA < v.length(); ++longueur_OA)
			Result[longueur_OA] = glm::isnan(v[longueur_OA]);
		return Result;
	}
...
#	endif
	...
	GLM_FUNC_QUALIFIER vec<L, bool, Q> isinf(vec<L, T, Q> const& v)
	{
		...
		vec<L, bool, Q> Result;
		for (length_t longueur_OA = 0; longueur_OA < v.length(); ++longueur_OA)
			Result[longueur_OA] = glm::isinf(v[longueur_OA]);
		return Result;
	}
...
#	endif
	...
	GLM_FUNC_QUALIFIER vec<L, T, Q> frexp(vec<L, T, Q> const& v, vec<L, int, Q>& exp)
	{
		...
		vec<L, T, Q> Result;
		for (length_t longueur_OA = 0; longueur_OA < v.length(); ++longueur_OA)
			Result[longueur_OA] = std::frexp(v[longueur_OA], &exp[longueur_OA]);
		return Result;
	}
	...
	GLM_FUNC_QUALIFIER vec<L, T, Q> ldexp(vec<L, T, Q> const& v, vec<L, int, Q> const& exp)
	{
		...
		vec<L, T, Q> Result;
		for (length_t longueur_OA = 0; longueur_OA < v.length(); ++longueur_OA)
			Result[longueur_OA] = std::ldexp(v[longueur_OA], exp[longueur_OA]);
		return Result;
	}
}//namespace glm
